const trans = {
	en: {
		...
		pricingGym: "gym planification",
		pricingLearn: "learn about rehabilitation and stretching",
		pricingBuild: "build visualization",
		pricingGoal: "goal-setting techniques",
		pricing8Weeks: "8 weeks",
		pricingNarrow: "Narrow Your Focus",
	...
	es: {
		...
		pricingGym: "planificacion del gimnasio",
		pricingLearn: "aprender sobre rehabilitación y estiramiento",
		pricingBuild: "construir visualización",
		pricingGoal: "técnicas de establecimiento de objetivos",
		pricing8Weeks: "8 semanas",
		pricingNarrow: "Limita tu enfoque",
